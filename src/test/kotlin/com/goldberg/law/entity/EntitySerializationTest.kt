...
class EntitySerializationTest {
    ...
    fun testStatementSerializable() {
        val statementGSON = GSON.fromJson(GSON.toJson(newStatement()), Statement::class.java)
        val statementJackson = OBJECT_MAPPER.readValue(OBJECT_MAPPER.writeValueAsString(newStatement()), Statement::class.java)
        assertThat(newStatement())
