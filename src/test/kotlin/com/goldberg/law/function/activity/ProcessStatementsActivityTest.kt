...
//            ),
//            mapOf(
//                FILE_10 to InputFileMetadata(10, true, true),
//                FILE_20 to InputFileMetadata(20, true, true),
//                FILE_30 to InputFileMetadata(30, true, true),
//            )
//        ), context)
//
...
//
//        verify(dataManager).updateInputPdfMetadata(CLIENT_NAME, FILE_10, InputFileMetadata(10, true, true, setOf(STATEMENT_1.azureFileName())))
//        verify(dataManager).updateInputPdfMetadata(CLIENT_NAME, FILE_20, InputFileMetadata(20, true, true, setOf(STATEMENT_2.azureFileName())))
//        verify(dataManager).updateInputPdfMetadata(CLIENT_NAME, FILE_30, InputFileMetadata(30, true, true, setOf(STATEMENT_3.azureFileName(), STATEMENT_4.azureFileName())))
...
//        private val STATEMENT_1 = newBankStatement(filename = FILE_10, statementDate = STATEMENT_DATE_1)
//            .update(pageMetadata = ModelValues.newTransactionPage(1, FILE_10))
//            .update(pageMetadata = ModelValues.newTransactionPage(2, FILE_10))
//
//        private val STATEMENT_2 = newBankStatement(filename = FILE_20, statementDate = STATEMENT_DATE_2)
//            .update(pageMetadata = ModelValues.newTransactionPage(1, FILE_20))
//            .update(pageMetadata = ModelValues.newTransactionPage(2, FILE_20))
//
//        private val STATEMENT_3 = newBankStatement(filename = FILE_30, statementDate = STATEMENT_DATE_3)
