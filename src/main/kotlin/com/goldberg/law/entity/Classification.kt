...
data class ClassificationInfo(
    ...
    companion object {
        fun fromRow(row: ResultRow) = ClassificationInfo(
            ...
            pages = OBJECT_MAPPER.readValue(row[ClassificationsTable.pages], object : TypeReference<Set<Int>>() {}),
            ...
            createdAt = row[ClassificationsTable.createdAt].epochSecond,
            updatedAt = row[ClassificationsTable.updatedAt].epochSecond
        )
    }
}
