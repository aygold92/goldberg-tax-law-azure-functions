...
MySQL with Jetbrains Exposed ORM. All DB operations use `DbExec.txnSafe {}` for transaction safety. HikariCP manages connection pooling (tuned for serverless cold starts: 120s connection timeout, 60s idle timeout).
