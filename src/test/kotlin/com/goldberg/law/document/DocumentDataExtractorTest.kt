...
//    @Mock
//    val client: DocumentIntelligenceClient = mock()
//    @Mock
//    private val poller: SyncPoller<AnalyzeOperationDetails, AnalyzeResult> = mock()
//
//    @Mock
//    val operationResult: PollResponse<AnalyzeOperationDetails> = mock()
//    @Mock
...
//            listOf(page1.readJson(AnalyzedDocument::class.java)),
//        )
//
...
//            pageMetadata = ClassifiedPdfMetadata(CHECK_FILENAME, 4, CheckTypes.EAGLE_BANK_CHECK),
//        ))
//    }
//
//    @Test
...
//                CheckEntriesTableRow(accountNumber = "1663", description = null, amount = 20000.asCurrency(), to = "Bank of America", checkNumber = 1, date = "2/29/2024", page = 1),
//                CheckEntriesTableRow(accountNumber = "1663", description = null, amount = 10000.asCurrency(), to = "Citi BANK", checkNumber = 3, date = "3/5/2024", page = 1),
//                CheckEntriesTableRow(accountNumber = "1663", description = null, amount = 9550.asCurrency(), to = "Cinci R. Brandt Esq.", checkNumber = 2, date = "3/6/2024", page = 1),
//                CheckEntriesTableRow(accountNumber = "1663", description = null, amount = 10000.asCurrency(), to = "Citi BANK", checkNumber = 4, date = "3/29/2024", page = 1),
//            )),
//            batesStamp = null,
//            pageMetadata = ClassifiedPdfMetadata(CHECK_FILENAME, 4, CheckTypes.NFCU_CHECK),
//        ))
//    }
//
//    @Test
...
//            null,
//            batesStamp = null,
//            pageMetadata = ClassifiedPdfMetadata(CHECK_FILENAME, 4, CheckTypes.MISC_CHECK),
//        ))
//    }
