...
class ProcessDataModelActivityTest {
    ...
    fun testFakeCheckModel() {
        val output = ProcessDataModelActivity(classifier, dataExtractor, dataManager).processDataModel(
            ProcessDataModelActivityInput("1234", PdfPageData("newpage.pdf", 1), null), context)
        ...
        assertThat(dataManager.saveModel(PdfPageData("newpage.pdf", 1), output.checkDataModel!!))
    }
    ...
    fun testFakeStatementModel() {
        val output = ProcessDataModelActivity(classifier, dataExtractor, dataManager).processDataModel(
            ProcessDataModelActivityInput("1234", PdfPageData("newpage.pdf", 2), null), context)
        ...
        assertThat(dataManager.saveModel(PdfPageData("newpage.pdf", 2), output.statementDataModel!!))
    }
    ...
    fun testFakeExtraPageModel() {
        val output = ProcessDataModelActivity(classifier, dataExtractor, dataManager).processDataModel(
            ProcessDataModelActivityInput("1234", PdfPageData("newpage.pdf", 6), null), context)
        ...
        assertThat(dataManager.saveModel(PdfPageData("newpage.pdf", 6), output.extraPageDataModel!!))
    }
}