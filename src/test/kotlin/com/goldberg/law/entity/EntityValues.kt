...
object EntityValues {
    ...
    const val DEFAULT_ACCOUNT_NUMBER = "1234567890"
    ...
    val DEFAULT_BEGINNING_BALANCE: BigDecimal = 1000.asCurrency()
    val DEFAULT_ENDING_BALANCE: BigDecimal = 500.asCurrency()
    ...
    fun newInputFileSummary(
        inputFile: InputFile = newInputFile(),
        numChecks: Int? = null,
        numStatements: Int? = null,
        numTransactions: Int? = null,
        numAnalyzed: Int? = null,
        statementMetadata: Map<String, StatementSummary>? = null,
    ) = InputFileSummary(
        inputFile = inputFile,
        numChecks = numChecks,
