    ...
    fun testInitialValue() {
        val status = OrchestrationStatusFactory().new(
            ...
            setOf(
                ...
                newClassification(FILE_ID_3, CLASSFN_ID_2, DocumentType.CheckTypes.MISC_CHECK),

            ),
            setOf(
                newClassifiedStatement(newClassification(FILE_ID_3, CLASSFN_ID_3, DocumentType.BankTypes.WF_BANK)),
                newClassifiedCheck(newClassification(FILE_ID_3, CLASSFN_ID_4, DocumentType.CheckTypes.MISC_CHECK)),
            )
        )
