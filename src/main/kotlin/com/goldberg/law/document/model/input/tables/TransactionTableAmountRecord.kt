...
data class TransactionTableAmountRecord @JsonCreator constructor(
    ...
    override fun toTransactionDetails(statementDate: Date?, classification: Classification): TransactionDetails {
        return TransactionDetails(
            ...
            amount = if (classification.documentType == DocumentType.CREDIT_CARD) amount?.negate() else amount,
