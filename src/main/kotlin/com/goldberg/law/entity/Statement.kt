...
data class StatementDetails(
    ...
    companion object {
        fun fromRow(row: ResultRow) = StatementDetails(
            ...
            beginningBalance = row[BankStatementsTable.beginningBalance],
            endingBalance = row[BankStatementsTable.endingBalance],
            interestCharged = row[BankStatementsTable.interestCharged],
            feesCharged = row[BankStatementsTable.feesCharged],
