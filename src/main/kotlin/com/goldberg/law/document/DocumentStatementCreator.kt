...
class DocumentStatementCreator @Inject constructor(private val bankStatementVerifier: BankStatementVerifier) {
    ...
    companion object {
        fun TransactionDetails.isBeginningBalanceRecord() = (this.description?.lowercase() in beginningBalanceTransactionDescriptions) && this.amount == null

        private const val NFCU_BANK_BEGINNING_BALANCE_TRANSACTION_DESCRIPTION = "Beginning Balance"
        private const val CAPITAL_ONE_JOINT_BEGINNING_BALANCE_TRANSACTION_DESCRIPTION = "Opening Balance"

        private val beginningBalanceTransactionDescriptions = listOf(
