...
//        }
//
//        statements.values.filter { it.isNFCUBank() }.map { stmt ->
//            stmt.copy(transactions = stmt.transactions.filter { it.isBeginningBalanceRecord() })
//        }
//
...
//            ?: lastJointStatementSummary?.findRelevantAccountIfMatches(statementDate, analyzedBankDocument.pageMetadata.classification)
