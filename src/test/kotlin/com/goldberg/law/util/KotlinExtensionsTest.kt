...
class KotlinExtensionsTest {
    ...
    fun testParseCurrencyOffBy01() {
        ...
        val field = valueString.readJson(DocumentField::class.java)
...
//    @Test
//    fun testToStringDetailedDocumentField() {
...
//        val value = valueString.readJson(AnalyzedDocument::class.java)
//
//        val result = value.toStringDetailed().also { println(it) }
//        val new = result.readJson(AnalyzedDocument::class.java)
//
...
//        val expected = expectedString.readJson(AnalyzedDocument::class.java)
//
